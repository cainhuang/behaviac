...
// Export file: bt/exported/generated_behaviors.cpp
// ---------------------------------------------------------------------
...
namespace framework
{
	...
	template<> BEHAVIAC_FORCEINLINE signed long& GameObject::_Get_Property_<PROPERTY_TYPE_framework_GameObject_age>()
	{
	...
	template<> BEHAVIAC_FORCEINLINE void GameObject::_Execute_Method_<METHOD_TYPE_framework_GameObject_GoStraight>(signed int& p0)
	{
	...
	template<> BEHAVIAC_FORCEINLINE signed int GameObject::_Execute_Method_<METHOD_TYPE_framework_GameObject_TurnTowardsTarget>(float& p0)
	{
...
namespace framework
{
	...
	template<> BEHAVIAC_FORCEINLINE signed int WorldState::_Execute_Method_<METHOD_TYPE_framework_WorldState_PlayerHP>()
	{
		return this->framework::WorldState::PlayerHP();
	}

	struct METHOD_TYPE_framework_WorldState_SpawnShip { };
	template<> BEHAVIAC_FORCEINLINE void WorldState::_Execute_Method_<METHOD_TYPE_framework_WorldState_SpawnShip>(signed int& p0)
	{
...
namespace behaviac
{
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			((framework::GameObject*)pAgent)->_Execute_Method_<framework::METHOD_TYPE_framework_GameObject_GoStraight, void, signed int >(method_p0);
			return BT_RUNNING;
		}
	...
	struct Register_bt_base_boring
	{
		Register_bt_base_boring()
		{
			Workspace::RegisterBehaviorTreeCreator("base/boring", Create_bt_base_boring);
		}
	};

	static Register_bt_base_boring register_bt_base_boring;
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
			BEHAVIAC_UNUSED_VAR(childStatus);
			((framework::GameObject*)pAgent)->_Execute_Method_<framework::METHOD_TYPE_framework_GameObject_TurnTowardsTarget, signed int, float >(method_p0);
			return BT_RUNNING;
		}
		float method_p0;
	};
	...
	struct Register_bt_base_homing
	{
		Register_bt_base_homing()
		{
			Workspace::RegisterBehaviorTreeCreator("base/homing", Create_bt_base_homing);
		}
	};

	static Register_bt_base_homing register_bt_base_homing;
	...
	struct Register_bt_base_slowboring
	{
		Register_bt_base_slowboring()
		{
			Workspace::RegisterBehaviorTreeCreator("base/slowboring", Create_bt_base_slowboring);
		}
	};

	static Register_bt_base_slowboring register_bt_base_slowboring;

	// Source file: base/sync_homing

	class BEHAVIAC_API Predicate_bt_base_sync_homing_attach3 : public Predicate
	{
	public:
		BEHAVIAC_DECLARE_DYNAMIC_TYPE(Predicate_bt_base_sync_homing_attach3, Predicate);
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
	...
	BEHAVIAC_API bool Create_bt_base_sync_homing(BehaviorTree* pBT)
	{
		...
		// children
		{
			...
			pBT->AddChild(node1);
			{
				...
				// attachments
				{
					Predicate_bt_base_sync_homing_attach3* attach3 = BEHAVIAC_NEW Predicate_bt_base_sync_homing_attach3;
					attach3->SetClassNameString("Predicate");
					attach3->SetId(3);
#if !defined(BEHAVIAC_RELEASE)
					attach3->SetAgentType("framework::GameObject");
#endif
					node2->Attach(attach3);
	...
	struct Register_bt_base_sync_homing
	{
		Register_bt_base_sync_homing()
		{
			Workspace::RegisterBehaviorTreeCreator("base/sync_homing", Create_bt_base_sync_homing);
		}
	};

	static Register_bt_base_sync_homing register_bt_base_sync_homing;

	// Source file: projectile/projectile_test

	class BEHAVIAC_API Predicate_bt_projectile_projectile_test_attach3 : public Predicate
	{
	public:
		BEHAVIAC_DECLARE_DYNAMIC_TYPE(Predicate_bt_projectile_projectile_test_attach3, Predicate);
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
	...
	class BEHAVIAC_API Predicate_bt_projectile_projectile_test_attach7 : public Predicate
	{
	public:
		BEHAVIAC_DECLARE_DYNAMIC_TYPE(Predicate_bt_projectile_projectile_test_attach7, Predicate);
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
	...
	class BEHAVIAC_API Predicate_bt_projectile_projectile_test_attach8 : public Predicate
	{
	public:
		BEHAVIAC_DECLARE_DYNAMIC_TYPE(Predicate_bt_projectile_projectile_test_attach8, Predicate);
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
	...
	protected:
		...
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
			BEHAVIAC_ASSERT(behaviac::MakeVariableId("par_test_b") == 3437442852u);
			return pAgent->GetVariable<int >(3437442852u);
		}
	};
	...
	class BEHAVIAC_API Predicate_bt_projectile_projectile_test_attach21 : public Predicate
	{
	public:
		BEHAVIAC_DECLARE_DYNAMIC_TYPE(Predicate_bt_projectile_projectile_test_attach21, Predicate);
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
	...
	class BEHAVIAC_API Predicate_bt_projectile_projectile_test_attach22 : public Predicate
	{
	public:
		BEHAVIAC_DECLARE_DYNAMIC_TYPE(Predicate_bt_projectile_projectile_test_attach22, Predicate);
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
...
#endif
		// pars
		pBT->AddPar("bool", "par_test_a", "false", "");
		pBT->AddPar("int", "par_test_b", "0", "");
		pBT->AddPar("float", "par_test_c", "0", "");
		pBT->AddPar("uint", "par_test_d", "0", "");
		// children
		{
			...
			pBT->AddChild(node1);
			{
				...
				// attachments
				{
					Predicate_bt_projectile_projectile_test_attach3* attach3 = BEHAVIAC_NEW Predicate_bt_projectile_projectile_test_attach3;
					attach3->SetClassNameString("Predicate");
					attach3->SetId(3);
#if !defined(BEHAVIAC_RELEASE)
					attach3->SetAgentType("framework::Projectile");
#endif
					node2->Attach(attach3);
					node2->SetHasEvents(node2->HasEvents() | (Event::DynamicCast(attach3) != 0));
				}
			...
			}
			{
				...
				// attachments
				{
					Predicate_bt_projectile_projectile_test_attach7* attach7 = BEHAVIAC_NEW Predicate_bt_projectile_projectile_test_attach7;
					attach7->SetClassNameString("Predicate");
					attach7->SetId(7);
#if !defined(BEHAVIAC_RELEASE)
					attach7->SetAgentType("framework::Projectile");
#endif
					node6->Attach(attach7);
					node6->SetHasEvents(node6->HasEvents() | (Event::DynamicCast(attach7) != 0));
				}
				{
					Predicate_bt_projectile_projectile_test_attach8* attach8 = BEHAVIAC_NEW Predicate_bt_projectile_projectile_test_attach8;
					attach8->SetClassNameString("Predicate");
					attach8->SetId(8);
#if !defined(BEHAVIAC_RELEASE)
					attach8->SetAgentType("framework::Projectile");
#endif
					node6->Attach(attach8);
			...
			}
			{
				...
				// attachments
				{
					Predicate_bt_projectile_projectile_test_attach21* attach21 = BEHAVIAC_NEW Predicate_bt_projectile_projectile_test_attach21;
					attach21->SetClassNameString("Predicate");
					attach21->SetId(21);
#if !defined(BEHAVIAC_RELEASE)
					attach21->SetAgentType("framework::Projectile");
#endif
					node20->Attach(attach21);
					node20->SetHasEvents(node20->HasEvents() | (Event::DynamicCast(attach21) != 0));
				}
				{
					Predicate_bt_projectile_projectile_test_attach22* attach22 = BEHAVIAC_NEW Predicate_bt_projectile_projectile_test_attach22;
					attach22->SetClassNameString("Predicate");
					attach22->SetId(22);
#if !defined(BEHAVIAC_RELEASE)
					attach22->SetAgentType("framework::Projectile");
#endif
					node20->Attach(attach22);
					node20->SetHasEvents(node20->HasEvents() | (Event::DynamicCast(attach22) != 0));
				}
	...
	struct Register_bt_projectile_projectile_test
	{
		Register_bt_projectile_projectile_test()
		{
			Workspace::RegisterBehaviorTreeCreator("projectile/projectile_test", Create_bt_projectile_projectile_test);
		}
	};

	static Register_bt_projectile_projectile_test register_bt_projectile_projectile_test;
	...
	protected:
		...
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
			BEHAVIAC_ASSERT(behaviac::MakeVariableId("par_c") == 2032254993u);
			return pAgent->GetVariable<float >(2032254993u);
		}
	};
...
#endif
		// pars
		pBT->AddPar("bool", "par_a", "false", "");
		pBT->AddPar("int", "par_b", "500", "");
		pBT->AddPar("float", "par_c", "1000", "");
		pBT->AddPar("string", "par_s", "", "");
		// children
		{
	...
	struct Register_bt_ships_0_basic
	{
		Register_bt_ships_0_basic()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/0_basic", Create_bt_ships_0_basic);
		}
	};

	static Register_bt_ships_0_basic register_bt_ships_0_basic;
...
#endif
				// pars
				node8->AddPar("int", "par_homing_a", "0", "");
	...
	struct Register_bt_ships_1_1_suicide
	{
		Register_bt_ships_1_1_suicide()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/1_1_suicide", Create_bt_ships_1_1_suicide);
		}
	};

	static Register_bt_ships_1_1_suicide register_bt_ships_1_1_suicide;
	...
	class BEHAVIAC_API Predicate_bt_ships_1_2_suicide_attach3 : public Predicate
	{
	public:
		BEHAVIAC_DECLARE_DYNAMIC_TYPE(Predicate_bt_ships_1_2_suicide_attach3, Predicate);
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
	...
	BEHAVIAC_API bool Create_bt_ships_1_2_suicide(BehaviorTree* pBT)
	{
		...
		// children
		{
			...
			pBT->AddChild(node1);
			{
				...
				// attachments
				{
					Predicate_bt_ships_1_2_suicide_attach3* attach3 = BEHAVIAC_NEW Predicate_bt_ships_1_2_suicide_attach3;
					attach3->SetClassNameString("Predicate");
					attach3->SetId(3);
#if !defined(BEHAVIAC_RELEASE)
					attach3->SetAgentType("framework::Ship");
#endif
					node2->Attach(attach3);
					node2->SetHasEvents(node2->HasEvents() | (Event::DynamicCast(attach3) != 0));
				}
...
#endif
					// pars
					node4->AddPar("int", "par_homing_a", "0", "");
					node2->AddChild(node4);
					node2->SetHasEvents(node2->HasEvents() | node4->HasEvents());
				}
				node1->SetHasEvents(node1->HasEvents() | node2->HasEvents());
	...
	struct Register_bt_ships_1_2_suicide
	{
		Register_bt_ships_1_2_suicide()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/1_2_suicide", Create_bt_ships_1_2_suicide);
		}
	};

	static Register_bt_ships_1_2_suicide register_bt_ships_1_2_suicide;
	...
	struct Register_bt_ships_1_3_suicide
	{
		Register_bt_ships_1_3_suicide()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/1_3_suicide", Create_bt_ships_1_3_suicide);
		}
	};

	static Register_bt_ships_1_3_suicide register_bt_ships_1_3_suicide;
	...
	struct Register_bt_ships_2_basic_probability
	{
		Register_bt_ships_2_basic_probability()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/2_basic_probability", Create_bt_ships_2_basic_probability);
		}
	};

	static Register_bt_ships_2_basic_probability register_bt_ships_2_basic_probability;
	...
	struct Register_bt_ships_3_basic_move
	{
		Register_bt_ships_3_basic_move()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/3_basic_move", Create_bt_ships_3_basic_move);
		}
	};

	static Register_bt_ships_3_basic_move register_bt_ships_3_basic_move;
	...
	struct Register_bt_ships_4_destroy_projectiles
	{
		Register_bt_ships_4_destroy_projectiles()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/4_destroy_projectiles", Create_bt_ships_4_destroy_projectiles);
		}
	};

	static Register_bt_ships_4_destroy_projectiles register_bt_ships_4_destroy_projectiles;
	...
	struct Register_bt_ships_5_group
	{
		Register_bt_ships_5_group()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/5_group", Create_bt_ships_5_group);
		}
	};

	static Register_bt_ships_5_group register_bt_ships_5_group;
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
			BEHAVIAC_UNUSED_VAR(childStatus);
			((framework::WorldState*)pAgent)->_Execute_Method_<framework::METHOD_TYPE_framework_WorldState_SpawnShip, void, signed int >(method_p0);
			return BT_SUCCESS;
		}
		signed int method_p0;
	};
	...
	struct Register_bt_ships_6_director
	{
		Register_bt_ships_6_director()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/6_director", Create_bt_ships_6_director);
		}
	};

	static Register_bt_ships_6_director register_bt_ships_6_director;
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			BEHAVIAC_ASSERT(behaviac::MakeVariableId("SyncSignal") == 404245629u);
			pAgent_opl->SetVariable("SyncSignal", ((framework::WorldState*)pAgent_opl)->_Get_Property_<framework::PROPERTY_TYPE_framework_WorldState_SyncSignal, bool >(), 404245629u);
			return result;
		}
	};
	...
	struct Register_bt_ships_7_signal
	{
		Register_bt_ships_7_signal()
		{
			Workspace::RegisterBehaviorTreeCreator("ships/7_signal", Create_bt_ships_7_signal);
		}
	};

	static Register_bt_ships_7_signal register_bt_ships_7_signal;
