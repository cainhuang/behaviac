...
// Export file: ../../../../../test/btperformance/behaviac_generated/behaviors/generated_behaviors.h
// ---------------------------------------------------------------------
...
#endif
			// pars
			pBT->AddPar("CPerformanceAgent", "float", "par_HungryThreshold", "60");
			pBT->AddPar("CPerformanceAgent", "float", "par_BigDistance", "30");
			pBT->AddPar("CPerformanceAgent", "float", "par_SmallDisance", "10");
			pBT->AddPar("CPerformanceAgent", "float", "par_HealthThreshold", "20");
			// children
			{
